...
void AM_Start(void)
{
    ...
    BG_PALETTE[1] = RGB8(0, 0xFF, 0);
    BG_PALETTE[2] = RGB8(0xA4, 0, 0);
    BG_PALETTE[3] = RGB8(0x8A, 0x5C, 0x30);
    BG_PALETTE[4] = RGB8(0x80, 0x80, 0x80);
    BG_PALETTE[5] = RGB8(0xCC, 0xCC, 0x00);
    BG_PALETTE[6] = RGB8(0x33, 0x73, 0xB3);
