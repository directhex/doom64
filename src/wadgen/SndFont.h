...
void SF_Setup(void);
void SF_AddSampleData(soundfont_t* sf, cache in, size_t insize, char* newname, int loopid);
void SF_AddSample(sfsample_t* sample, char* name, size_t size, size_t offset, int loopid);
void SF_CreatePresets(patch_t* patch, int npatch, subpatch_t* subpatch, int nsubpatch, wavtable_t* wavtable);
